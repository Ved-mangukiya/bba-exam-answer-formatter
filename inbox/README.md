...
## How It Works
- Any JSON file placed here is automatically recognized by subject (BSL, PPM, FA, GCE, IKS, ESG), validated, and placed into its proper folder under `data/sem-<N>/<subject-slug>/`.
